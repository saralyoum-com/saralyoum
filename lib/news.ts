...
// Shared by app/api/news/route.ts (client-side fetches on /اخبار) and
// app/page.tsx (home page, called directly in-process — NOT via a
// self-referential fetch("${VERCEL_URL}/api/news"), which was unreliable and
...
export async function getNewsData(lang: "ar" | "en"): Promise<NewsItem[]> {
...
function getMockNewsAr(): NewsItem[] {
  ...
  return [
    ...
    },
    {
      ...
      description: "واصل الريال السعودي استقراره في نطاق الربط الثابت مع الدولار الأمريكي.",
      url: "#",
      source: "الجزيرة",
    ...
    },
    {
      ...
      description: "تراجع سعر إيثيريوم مع خروج السيولة قبيل ترقية الشبكة المخططة الشهر القادم.",
      url: "#",
      source: "أرقام",
...
function getMockNewsEn(): NewsItem[] {
  ...
  return [
    ...
    },
    {
      ...
      description: "Bitcoin hit new highs driven by massive ETF inflows and easing inflation concerns.",
      url: "#",
      source: "MarketWatch",
      publishedAt: new Date(now.getTime() - 7200000).toISOString(),
    },
    {
      ...
      description: "Silver surged sharply amid rising industrial demand and declining global inventories.",
      url: "#",
      source: "Kitco",
      publishedAt: new Date(now.getTime() - 10800000).toISOString(),
    },
    {
      ...
      description: "Ethereum prices fell as liquidity exited ahead of the planned network upgrade next month.",
      url: "#",
    ...
    },
    {
      ...
      description: "Crude oil prices stabilized as OPEC+ members discussed potential supply adjustments.",
      url: "#",
      source: "Reuters",
      publishedAt: new Date(now.getTime() - 18000000).toISOString(),
    },
