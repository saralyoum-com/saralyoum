...
// few thousand — plenty for this site's subscriber count).
export async function listPlayers(): Promise<Array<{ id: string; last_active: number; invalid_identifier: boolean }>> {
