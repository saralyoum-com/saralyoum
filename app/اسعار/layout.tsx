...
export const metadata: Metadata = {
  title: "أسعار الذهب اليوم — عيار 24 و21 والفضة والبيتكوين لحظياً",
  description:
    "أسعار الذهب والفضة والبيتكوين والإيثيريوم لحظياً — عيار 24/22/21/18 بالريال والدرهم والدينار وأكثر من 27 عملة. محدّث كل دقيقة من مصادر عالمية.",
  keywords: [
    "سعر الذهب اليوم",
    "سعر عيار 21",
    "سعر عيار 24",
