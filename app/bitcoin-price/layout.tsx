...
export const metadata: Metadata = {
  title: "سعر البيتكوين اليوم — البيتكوين مقابل الريال والدرهم والدينار",
  description:
    "سعر البيتكوين مقابل الريال السعودي والدرهم الإماراتي والدينار الكويتي والجنيه المصري لحظياً — محدّث كل 5 دقائق مع حاسبة تحويل BTC لجميع العملات العربية.",
  keywords: [
    "سعر البيتكوين اليوم",
  ...
  openGraph: {
    title: "سعر البيتكوين اليوم — البيتكوين مقابل الريال والدرهم والدينار",
    description:
      "سعر البيتكوين مقابل الريال السعودي والدرهم الإماراتي والدينار الكويتي لحظياً — محدّث كل 5 دقائق.",
    type: "website",
    images: [
      {
