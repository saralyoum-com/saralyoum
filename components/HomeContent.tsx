...
export function HomeAdAndCTA() {
  ...
  return (
    <>
      ...
      <div
        dir={dir}
        className="bg-gradient-to-l from-gold/5 to-gold/10 border border-gold/20 rounded-2xl p-6 mb-12 flex flex-col md:flex-row items-center justify-between gap-4"
      >
        <div>
          <h2 className="text-xl font-bold text-text-primary mb-1">{t.home.ctaTitle}</h2>
...
export function HomeNewsSection({ news }: { news: NewsItem[] }) {
  ...
  return (
    <>
      {/* قسم الأخبار */}
      <section dir={dir} className="max-w-7xl mx-auto px-4 pb-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-text-primary">{t.home.latestNews}</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {links.map((link) => (
          ...
          >
            ...
            <h3 className="text-text-primary font-bold mb-2 group-hover:text-gold transition-colors">{link.title}</h3>
